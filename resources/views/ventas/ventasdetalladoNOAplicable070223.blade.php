...
{{-- ///////////////////////////////////////////////////////////////////////////////// --}}
        ...
        <table class="table table-light " id="tb_vtasdetallada">
            ...
            <tbody>
                @foreach ($detalle as $key=>$unprod)
                    ...
                    @endif
                        ...
                        @if ($unprod->formapago=="mixto")
                            <td>
                            @php
                                $elmixto=json_encode($unprod->pagomixto)
                            @endphp
                            @foreach (json_decode($unprod->pagomixto) as $key => $unmixto)
                               {{$key}} {{$unmixto}}<br>
                            @endforeach
                            </td>
                            {{-- @php
                ...
                @endforeach
                <tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td style="text-align:right;font-weight:bold;font-size:1.5em">Totales: </td>
                    ...
                    <td id="totalpagado" style="font-weight:bold;font-size:1.5em;border:1px solid silver;">0</td>
                    <td id="totalsaldo" style="font-weight:bold;font-size:1.5em;border:1px solid silver;">0</td>
...
<script>
    ...
    function totaliza(){
        ...
        for(k=1;k<nrofilas;k++){
                ...
                totalpagado+=parseFloat(tb.rows[k].cells[14].innerText);
                totalsaldo+=parseFloat(tb.rows[k].cells[15].innerText);
        ...
        document.getElementById("totalpagado").innerText=totalpagado;
