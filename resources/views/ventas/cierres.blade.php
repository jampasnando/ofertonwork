...
@section('contenido')
        ...
        @endphp
        <div class="titulo">
            <h3>Historial de cierres de caja <span style="color:darkorange"> del mes </span></h3>
            ...
            <tbody>
                @foreach ($lista as $key=>$uncierre)
                    <tr >
                        ...
                        <td>{{$uncierre->deposito}}</td>
                        <td>{{$uncierre->observacion}}</td>
                        <td>{{$uncierre->total}}</td>
                        <td><a href="{{route("cierres.detcierres",["fechacierre"=>$uncierre->fecha,"obs"=>$uncierre->observacion,"idcierre"=>$uncierre->id])}}" class="btn btn-warning">Ver Detalle</a></td>
                    </tr>
                @endforeach
        ...
        <form action="histcierres" method="post" id="cierremes">
            @csrf
