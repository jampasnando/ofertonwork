@extends('layouts.plantillavendedortienda')
<style>
    #tablaclis td{
...
<div class="nuevoprod">
    ...
    @if (session("guardado"))
        ...
        @endif
    <h4 class="card-header">Registrar Venta de Tienda Online - origen: <span id="origen" style="font-weight: bold"></span></h4> <br>  
    <input type="hidden" name="idpreventa" id="idpreventa" value="">
    {{-- <div class="reservas">
    ...
    <div class="cabeceraventa">
        <div class="input-group">
            ...
            <input type="hidden" name="depoculto" id="depoculto">
    ...
    <div>
        ...
        <div class="complementos">
            <div id="clientetienda" style="font-style: italic;font-size: 0.8em;font-weight: bold;color: orange;"></div>
            <div class="row">
                <div class="col-8">
                    <div class="input-group mb-1">
        ...
        <div class="col-12" style="text-align: center" id="botonesguardar">
...
<textarea name="datos" id="datos" cols="30" rows="10" style="display: none;">
    {{$datos}}
</textarea>
...
<script>
    ...
    window.onload=function(){
        ...
        document.getElementById("deposito").value=datos.deposito;
        document.getElementById("depoculto").value=datos.deposito;
        document.getElementById("clientetienda").innerText="Cliente: "+ datos.cliente + " | " + datos.celular;
        document.getElementById("buscacli").value=datos.celular;
        document.getElementById("origen").innerText=datos.origen;
        console.log("datos: ",datos);
        datos.json=JSON.parse(datos.json);
        console.log("datos: ",datos);
        if(datos.json[0].unvendedor!=""){
            vendedorelegido(datos.json[0].unvendedor.id,datos.json[0].unvendedor.nombre);
        }
        datos.json[0].carrito.forEach(unaventa => {
            console.log("unaventa: ",unaventa);
            elegidoini(unaventa.id,unaventa.descripcion,unaventa.precioventa,unaventa.preciolocal,unaventa.comision,unaventa.cantidad,unaventa.idprod,unaventa.preciofinal,unaventa.cuantos);
        });
        if(datos.metodopago=="qr"){
            document.getElementById("qr").value=document.getElementById("efectivo").value;
        }
        if(datos.metodopago=="transferencia"){
            document.getElementById("transferencia").value=document.getElementById("efectivo").value;
        }
        ...
        if(nrofilas==1 || document.getElementById("cliente").value==""){
            ...
            .then(res => {
                ...
                if(res=="registrado"){
                    ...
                    window.location="http://127.0.0.1:8000/listapreventas";
                }
                else{
                    alert("Algo falló, vuelve a intentar");
                    document.getElementById("btnguardar").disabled=false;
                }
    ...
    function elegidoini(id,descr,precioventa,preciolocal,comision,cantidad,idprod,preciofinal,cuantos){
        ...
        celda.innerHTML="<input type='number' value='"+preciofinal+"' name='pfinal_"+nro+"' id='pfinal_"+nro+"' onchange='cambiacant(this)'  class='form-control' style='text-align:right'>";
        celda=fila.insertCell();
        celda.style.width="7em";
        celda.innerHTML="<input type='number' value='"+cuantos+"' name='c_"+nro+"' id='c_"+nro+"' onchange='cambiacant(this)'  class='form-control' style='text-align:center'>";
        celda=fila.insertCell();
        celda.style.textAlign="right";
        celda.innerText=preciofinal * cuantos;
        celda=fila.insertCell();
