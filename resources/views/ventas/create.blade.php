...
<div class="nuevoprod">
    ...
    @if (session("guardado"))
        ...
        @endif
    <h1 class="card-header">Registrar Venta</h1> <br>   
...
<div class="nuevoprod">
    ...
    @if (session("guardado"))
        ...
        @endif
    <h1 class="card-header">Registrar Venta</h1> <br>   
    <form action="guardanuevoprod" method="post" id="formuventa">
        @csrf
        <div style="background:aliceblue;padding:1em">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Buscar producto" id="texto" style="background: aliceblue">
                <a href="" class="btn btn-secondary" id="borrar" style="display:none" onclick="borrar(event)">X</a>
                <span class="input-group-text" id="basic-addon2">Buscar</span>
            </div>
            <div class="resultadobusq" id="resultadobusq"></div>
    ...
    <br>
        <div class="complementos">
            <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm">Cliente</span>
                <input type="text" class="form-control" aria-label="Sizing example input" id="cliente" aria-describedby="inputGroup-sizing-sm">
              </div>
              <div class="input-group mb-3">
                <span class="input-group-text" id="inputGroup-sizing-sm">NIT</span>
                <input type="text" class="form-control" id="nit" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Buscar vendedor" id="vendedor" style="background: lightyellow">
                <span class="input-group-text" id="basic-addon2">Buscar</span>
            </div>
            <div class="resultadobusq2" id="resultadobusq2"></div>
        </div>
...
<script>
    ...
    function elegido(id,descr,precioventa,preciolocal,comision){
        console.log(id,descr);
        tabla=document.getElementById("detalleventa");
        nro=tabla.rows.length;
        fila=tabla.insertRow();
